...
exports.SPIDER_MESSAGE_POOLS = void 0;
exports.pickSpiderMessage = pickSpiderMessage;
/** Only lines the spider may say in the speech bubble. */
exports.SPIDER_MESSAGE_POOLS = {
    idle: [
...
function pickSpiderMessage(state, lastMessage) {
    const pool = exports.SPIDER_MESSAGE_POOLS[state];
    if (pool.length === 0)
        return '';
    if (pool.length === 1)
        return pool[0];
